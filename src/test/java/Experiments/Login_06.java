...
public class Login_06 extends Base_Class
{
	
	        
	
	public Login_06 ()                                                                    // Create Login_Constructor, with and declare super() Keyword --> means super class constructor means Base_Class (extends) is super class of Login_Class 
