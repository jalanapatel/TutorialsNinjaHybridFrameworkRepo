...
public class Login_04 extends Base_Class
{
	
	        
	
	public Login_04 ()                                                                    // Create Login_Constructor, with and declare super() Keyword --> means super class constructor means Base_Class (extends) is super class of Login_Class 
	...
	public void setUp()
							...
							// 	loadPropertiesFile();                                                                                           // Calling method from Base_Class, to load Property_File  -- second way to Load Property_File
								...
								driver.findElement(By.linkText("Login_05")).click();
							}
